...
function Request() {
  const { data } = useFetch(
    `${import.meta.env.VITE_API_URL}/getRequestReports/getReport`
  );
  console.log(data);
      ...
      <div className="dashboard">
        ...
        <div className="dashboard-content shadow-2xl">
          <div className="w-full">
            <Contents />
            <button
              className="btn-user mt-14 delay-[300ms] duration-[600ms] text-sm  mr-20 mb-20 bg-blue-900"
              data-aos="fade-down"
            >
              Send a request
            </button>
            <button
              className="btn-user mt-14 delay-[300ms] duration-[600ms] text-sm  mr-8 mb-20 bg-blue-900"
              data-aos="fade-down"
              onClick={openModal}
            >
              Add a request
              ...
              <tbody>
                {data?.reportData.map((report) => (
                  <tr data-aos="zoom-in-down" key={crypto.randomUUID()}>
                    ...
                    <td>
                      <button className="bg-blue-900 text-white rounded-full py-2 px-8 text-sm">
                        Approved
                      </button>
                    </td>
                  </tr>
